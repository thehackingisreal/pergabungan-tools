...
__banner__ = """
  ...
  Author: the dark night
   ...
   Made with full of \033[1;31m<3\033[0m
"""
...
def spam():
	...
	if sys.argv[1] == "--sms":
		...
		print __banner__
		print "Usage: call.py [--sms/--call] nomor"
		print "call.py: error: %s option requires an argument" %options
		sys.exit()

if __name__ == '__main__':
	if len(sys.argv) != 3:
		print __banner__
		print "Usage: call.py [--sms/--call] PHONE"
		sys.exit(0)
	else:
		spam()